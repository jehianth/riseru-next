...
const Whychooseus = () => {
    ...
    return (
        <section id='whychooseus' className='bg-orange-600 w-full flex flex-col items-center justify-center'>
            ...
            <div className='bg-white my-10 mx-4 md:m-10 h-[850px] md:w-[800px] md:h-[500px] rounded-xl flex flex-col md:flex-row items-center justify-center'>
                ...
                {benefit.map((poin, index) => (
                    <div key={index} className='mr-10 ml-4 md:ml-0'>
                        ...
                        <h6 className='text-zinc-600 ml-20 md:ml-[46px] text-justify'>{poin.desc}</h6>
                    </div>
                ))}
            </div>
            </div>
