...
const Aboutus = () => {
    return (
        <section id='aboutus' className='bg-white w-full flex flex-col items-center justify-center'>
            ...
            <div className='bg-white border shadow-md shadow-orange-600 my-10 mx-4 md:m-10 h-[920px] md:w-[850px] md:h-[500px] rounded-xl flex flex-col md:flex-row items-center justify-center'>
                ...
                <div>
                    <div className='mx-6 md:ml-20'>
                        <div className='flex items-center'>
                            <h6 className='text-black font-semibold text-xl ml-28 md:ml-[70px] md:mb-4'>Riseru Hobby Shop</h6>
                        </div>
            ...
            <Image src='/about.svg' width={280} height={447} alt='' className='hidden md:block md:ml-10 md:mr-20 mb-4'></Image>
            </div>
            {/*  */}
        </section>
    )
