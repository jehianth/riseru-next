...
const Aboutus = () => {
    return (
        <section id='aboutus' className='bg-white w-full flex flex-col items-center justify-center'>
            ...
            <div className='bg-white border shadow-md shadow-orange-600 m-10 w-96 h-[920px] md:w-[850px] md:h-[500px] rounded-xl flex flex-col md:flex-row items-center justify-center'>
                ...
                <div>
                    <div className='mx-6 md:ml-20'>
                        <div className='flex items-center'>
                            <h6 className='text-black font-semibold text-xl ml-[70px] md:mb-4'>Riseru Hobby Shop</h6>
                        </div>
